...
class CustomTypeAheadFormField<T> extends FormField<String> {
  /// The configuration of the [TextField](https://docs.flutter.io/flutter/material/TextField-class.html)
  /// that the TypeAhead widget displays
  final TextFieldConfiguration textFieldConfiguration;

  /// Creates a [CustomTypeAheadFormField]
...
class _TypeAheadFormFieldState<T> extends FormFieldState<String> {
  ...
  @override
  CustomTypeAheadFormField get widget => super.widget;
  ...
  @override
  void didUpdateWidget(CustomTypeAheadFormField oldWidget) {
...
/// See also:
///
/// * [CustomTypeAheadFormField], a [FormField](https://docs.flutter.io/flutter/widgets/FormField-class.html)
/// implementation of [TypeAheadField] that allows the value to be saved,
/// validated, etc.
class TypeAheadField<T> extends StatefulWidget {
  ...
  @override
  _CustomTypeAheadFieldState<T> createState() =>
      _CustomTypeAheadFieldState<T>();
}

class _CustomTypeAheadFieldState<T> extends State<TypeAheadField<T>>
